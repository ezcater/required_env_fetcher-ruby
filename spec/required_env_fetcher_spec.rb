...
RSpec.describe RequiredEnvFetcher do
  describe ".fetch" do
    ...
    context "when the key is set in the environment" do
    ...
    context "when the key is not set in the environment" do
      context "when we're allowing required environment variables to get default values" do
        around do |example|
      ...
      context "when we're not allowing required environment variables to get default values" do
